...
# Устанавливаем фон и позицию героя для джунглевого уровня
level_2.set_back('jungle.png')
level_2.set_hero(300, 350)
level_2.min_x = 0
level_2.max_x = win_width * 15

level_2.add_enemy(0, 500, 150, 400, 600, 2)


level_2.add_platform(100, 500, 200, 50, 10, 0, 0)
level_2.add_platform(320, 450, 150, 50, 10, 0, 0)
level_2.add_platform(500, 500, 200, 50, 10, 0, 0)
level_2.add_platform(750, 550, 150, 50, 10, 0, 0)
level_2.add_platform(950, 500, 200, 50, 10, 0, 0)

level_2.set_goal(1100,300)
